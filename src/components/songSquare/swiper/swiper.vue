...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data() {
      return {
        list: [
          {path: '/songSquare/one', component: one},
          {path: '/songSquare/two', component: two},
          {path: '/songSquare/three', component: three},
          {path: '/songSquare/four', component: four},
          {path: '/songSquare/five', component: five}
        ]
      }
    },
    mounted() {
