...
// export const COM_SAVE_SEARCH_HISTORTY = 'COM_SAVE_SEARCH_HISTORTY'//保存搜索历史

// export const SET_PLAYLIST = 'SET_PLAYLIST'//播放列表
// export const SET_CURRENT_INDEX = 'SET_CURRENT_INDEX' //设置播放音乐的索引
// export const SET_PLAYING = 'SET_PLAYING' //控制播放
// export const SAVE_PLAY_HISTORY = 'SAVE_PLAY_HISTORY'//保存播放历史
// export const SAVE_FAVORITE_LIST = 'SAVE_FAVORITE_LIST' //保存喜欢的歌曲列表
